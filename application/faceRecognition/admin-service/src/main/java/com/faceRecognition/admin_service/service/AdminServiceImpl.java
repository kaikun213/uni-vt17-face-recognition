...
public class AdminServiceImpl implements AdminService {
	...
	public UserEntity create(String file, String personalNumber)
			throws InvalidAttributeValueException, UnirestException, FaceClientException, FaceServerException {
	...
	public UserEntity update(String file, String id, String personalNumber)
			throws NotFoundException, UnirestException, FaceClientException, FaceServerException {
		String url = storageService.store(file);
