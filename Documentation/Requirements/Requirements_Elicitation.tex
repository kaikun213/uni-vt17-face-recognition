...
\begin{tabular}{|p{3.5cm}|p{11.5cm}|} \hline
    ...
    \textbf{Primary flow} & 
    \textbf{1)} FNS receive a POST request \\&
    \textbf{2)} FNS accept the request and save the user's image and PN \\&
    ...
    \textbf{2a)} FNS reject the request because user's image file is corrupted \\&
    ...
    \textbf{2a)} FNS reject the request because user's PN format is incorrect \\&
    \textbf{2b)} FNS send a failure notification to admin\\&
    \textbf{2c)} Admin receive a failure notification
