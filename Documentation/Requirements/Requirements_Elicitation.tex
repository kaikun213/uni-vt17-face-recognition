...
\emph{Authors:} Walid Balegh, Jakob Heyder, Sarpreet Singh Buttar \\ \hspace{45pt} Henry Pap and Oscar Maris \\ % Author
...
\begin{tabular}{|p{4cm}|p{11cm}|} \hline
   ...
   \\ \hline \rowcolor{Gray} & \\ \hline
    ...
    2a) FNS reject the request because user's image is corrupted and PN is invalid\\&
    2b) FNS send a failure notification \\&
    2c) Admin receive a failure notification \\&
    ...
    2a) FNS reject the request because user's image is corrupted and PN format is incorrect\\&
    2b) FNS send a failure notification \\&
    2c) Admin receive a failure notification
    \\\hline 
\end{tabular}
